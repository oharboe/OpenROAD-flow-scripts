...
model anchored to published 7 nm SP-SRAM IP (Suzuki et al., ISSCC 2018;
TSMC N7 SRAM compiler datasheet figures). These are budgetary models —
good enough to make floorplanning, placement, and timing behave
representatively; not sign-off numbers.
