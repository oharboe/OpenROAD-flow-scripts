...
append_env_var global_placement_args GPL_WIRELENGTH_PENALTY -init_wirelength_coef 1.0
append_env_var global_placement_args GPL_TIMING_SPAN_CLOCK_PERCENT -virtual_cts_max_skew_fraction -1.0
